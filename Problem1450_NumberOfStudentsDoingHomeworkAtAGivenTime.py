...
Runtime: 35 ms, Beat: 83.51%
Memory: 13.8 MB, Beat: 60.40%
Description:
...
class TestSolution(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.testCase1 = ([1, 2, 3], [3, 2, 7], 4)

    def test_test_case_1(self):
        self.assertEqual(1, self.solution.busyStudent(self.testCase1[0], self.testCase1[1], 4))
