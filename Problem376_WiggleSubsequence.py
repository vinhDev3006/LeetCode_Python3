...
Runtime: 37ms, Beats: 61.24%
Memory: 13.8MB, Beats: 97.56%
Description:
...
its last difference is zero. A subsequence is obtained by deleting some elements (possibly zero) from the
